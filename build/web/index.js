...
// include: C:\Users\THECU~1.BIG\AppData\Local\Temp\tmpa881_bp2.js
...
// end include: C:\Users\THECU~1.BIG\AppData\Local\Temp\tmpa881_bp2.js
// include: C:\Users\THECU~1.BIG\AppData\Local\Temp\tmp6yxboh56.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\THECU~1.BIG\AppData\Local\Temp\tmp6yxboh56.js
// include: C:\Users\THECU~1.BIG\AppData\Local\Temp\tmp_3fojaq3.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\THECU~1.BIG\AppData\Local\Temp\tmp_3fojaq3.js
...
var ASM_CONSTS = {
  143152: () => { if (document.fullscreenElement) return 1; },  
 143198: () => { return document.getElementById('canvas').width; },  
 143250: () => { return parseInt(document.getElementById('canvas').style.width); },  
 143318: () => { document.exitFullscreen(); },  
 143345: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 143418: () => { if (document.fullscreenElement) return 1; },  
 143464: () => { return document.getElementById('canvas').width; },  
 143516: () => { return screen.width; },  
 143541: () => { document.exitFullscreen(); },  
 143568: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 143701: () => { return window.innerWidth; },  
 143727: () => { return window.innerHeight; },  
 143754: () => { if (document.fullscreenElement) return 1; },  
 143800: () => { return document.getElementById('canvas').width; },  
 143852: () => { return parseInt(document.getElementById('canvas').style.width); },  
