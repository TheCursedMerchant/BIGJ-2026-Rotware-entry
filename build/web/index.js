...
<<<<<<< HEAD
// include: C:\Users\denze\AppData\Local\Temp\tmphklp9a6l.js
=======
// include: C:\Users\THECU~1.BIG\AppData\Local\Temp\tmpz4xzu3rk.js
>>>>>>> d9739637cbe7e1036c55edb36cc2ee4dab08ae29
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/atlas.png", "start": 0, "end": 7580}], "remote_package_size": 7580});

  })();

<<<<<<< HEAD
// end include: C:\Users\denze\AppData\Local\Temp\tmphklp9a6l.js
// include: C:\Users\denze\AppData\Local\Temp\tmp2n029k65.js
=======
// end include: C:\Users\THECU~1.BIG\AppData\Local\Temp\tmpz4xzu3rk.js
// include: C:\Users\THECU~1.BIG\AppData\Local\Temp\tmpgo70fwi5.js
>>>>>>> d9739637cbe7e1036c55edb36cc2ee4dab08ae29
...
<<<<<<< HEAD
  // end include: C:\Users\denze\AppData\Local\Temp\tmp2n029k65.js
// include: C:\Users\denze\AppData\Local\Temp\tmpj1w4ecae.js
=======
  // end include: C:\Users\THECU~1.BIG\AppData\Local\Temp\tmpgo70fwi5.js
// include: C:\Users\THECU~1.BIG\AppData\Local\Temp\tmp0wg3ch0c.js
>>>>>>> d9739637cbe7e1036c55edb36cc2ee4dab08ae29
...
<<<<<<< HEAD
  // end include: C:\Users\denze\AppData\Local\Temp\tmpj1w4ecae.js
=======
  // end include: C:\Users\THECU~1.BIG\AppData\Local\Temp\tmp0wg3ch0c.js
>>>>>>> d9739637cbe7e1036c55edb36cc2ee4dab08ae29
...
<<<<<<< HEAD
 ...
 143842: () => { return parseInt(document.getElementById('canvas').style.width); },  
 143910: () => { document.exitFullscreen(); },  
 143937: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 144010: () => { if (document.fullscreenElement) return 1; },  
 144056: () => { return document.getElementById('canvas').width; },  
 144108: () => { return screen.width; },  
 144133: () => { document.exitFullscreen(); },  
 144160: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 144293: () => { return window.innerWidth; },  
 144319: () => { return window.innerHeight; },  
 144346: () => { if (document.fullscreenElement) return 1; },  
 144392: () => { return document.getElementById('canvas').width; },  
 144444: () => { return parseInt(document.getElementById('canvas').style.width); },  
 144512: () => { if (document.fullscreenElement) return 1; },  
 144558: () => { return document.getElementById('canvas').width; },  
 144610: () => { return screen.width; },  
 144635: () => { return window.innerWidth; },  
 144661: () => { return window.innerHeight; },  
 144688: () => { if (document.fullscreenElement) return 1; },  
 144734: () => { return document.getElementById('canvas').width; },  
 144786: () => { return screen.width; },  
 144811: () => { document.exitFullscreen(); },  
 144838: () => { if (document.fullscreenElement) return 1; },  
 144884: () => { return document.getElementById('canvas').width; },  
 144936: () => { return parseInt(document.getElementById('canvas').style.width); },  
 145004: () => { document.exitFullscreen(); },  
 145031: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 145089: () => { return screen.width; },  
 145114: () => { return screen.height; },  
 145140: () => { return window.screenX; },  
 145167: () => { return window.screenY; },  
 145194: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 145247: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 145318: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 145375: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 145631: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 145702: () => { if (document.fullscreenElement) return 1; },  
 145748: () => { return window.innerWidth; },  
 145774: () => { return window.innerHeight; },  
 145801: () => { if (document.pointerLockElement) return 1; },  
 145848: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 148006: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 148170: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 148274: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 148445: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 151273: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 151339: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 151732: ($0) => { miniaudio.untrack_device_by_index($0); },  
 151775: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 151900: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
=======
  142744: () => { if (document.fullscreenElement) return 1; },  
 142790: () => { return document.getElementById('canvas').width; },  
 142842: () => { return parseInt(document.getElementById('canvas').style.width); },  
 142910: () => { document.exitFullscreen(); },  
 142937: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 143010: () => { if (document.fullscreenElement) return 1; },  
 143056: () => { return document.getElementById('canvas').width; },  
 143108: () => { return screen.width; },  
 143133: () => { document.exitFullscreen(); },  
 143160: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 143293: () => { return window.innerWidth; },  
 143319: () => { return window.innerHeight; },  
 143346: () => { if (document.fullscreenElement) return 1; },  
 143392: () => { return document.getElementById('canvas').width; },  
 143444: () => { return parseInt(document.getElementById('canvas').style.width); },  
 143512: () => { if (document.fullscreenElement) return 1; },  
 143558: () => { return document.getElementById('canvas').width; },  
 143610: () => { return screen.width; },  
 143635: () => { return window.innerWidth; },  
 143661: () => { return window.innerHeight; },  
 143688: () => { if (document.fullscreenElement) return 1; },  
 143734: () => { return document.getElementById('canvas').width; },  
 143786: () => { return screen.width; },  
 143811: () => { document.exitFullscreen(); },  
 143838: () => { if (document.fullscreenElement) return 1; },  
 143884: () => { return document.getElementById('canvas').width; },  
 143936: () => { return parseInt(document.getElementById('canvas').style.width); },  
 144004: () => { document.exitFullscreen(); },  
 144031: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 144089: () => { return screen.width; },  
 144114: () => { return screen.height; },  
 144140: () => { return window.screenX; },  
 144167: () => { return window.screenY; },  
 144194: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 144247: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 144318: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 144375: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 144631: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 144702: () => { if (document.fullscreenElement) return 1; },  
 144748: () => { return window.innerWidth; },  
 144774: () => { return window.innerHeight; },  
 144801: () => { if (document.pointerLockElement) return 1; },  
 144848: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 147006: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 147170: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 147274: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 147445: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 150273: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 150339: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 150732: ($0) => { miniaudio.untrack_device_by_index($0); },  
 150775: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 150900: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
>>>>>>> d9739637cbe7e1036c55edb36cc2ee4dab08ae29
};
